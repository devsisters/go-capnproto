...
func (n *node) defineTypeCaplitMarshalFuncs(w io.Writer) {
	g_imported["io"] = true
	...
	switch n.Which() {
	case NODE_ENUM:
		n.caplitMarshalEnum(w)
	case NODE_STRUCT:
		n.caplitMarshalStruct(w)
	}
...
func (f *Field) caplitMarshal(w io.Writer) {
...
func (t Type) caplitMarshal(w io.Writer) {
	switch t.Which() {
